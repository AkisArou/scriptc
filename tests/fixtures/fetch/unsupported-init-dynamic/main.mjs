...
function indirect(init) {
    return fetch("http://127.0.0.1:1", init);
}
function rejectedOption(name, source) {
    return __awaiter(this, void 0, void 0, function () {
        var error_1, caught_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, indirect(JSON.parse(source))];
                case 1:
                    _a.sent();
                ...
                case 2:
                    error_1 = _a.sent();
                    caught_1 = error_1;
                    console.log(name, caught_1.name, caught_1.message);
                    return [3 /*break*/, 3];
...
var envProxyDispatcher = new EnvProxyDispatcher();
try {
...
var fromStream = ReadableStream.from([7]);
var fromPart = await fromStream.getReader().read();
console.log("stream from:", fromPart.done, fromPart.done ? -1 : fromPart.value);
var constructed = new ReadableStream();
