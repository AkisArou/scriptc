...
const signed8 = ((127 as i8) + (1 as i8)) as i8;
const unsigned8Zero = ((128 as u8) * (2 as u8)) as u8;
const unsigned8 = (unsigned8Zero - (1 as u8)) as u8;
const signed16 = ((16384 as i16) * (2 as i16)) as i16;
const unsigned16Zero = ((32768 as u16) * (2 as u16)) as u16;
const unsigned16 = (unsigned16Zero - (1 as u16)) as u16;
...
const signed32 = (signed32Added + signed32ProductDelta) as i32;
const unsigned32Zero = ((2147483648 as u32) * (2 as u32)) as u32;
const unsigned32 = (unsigned32Zero - (1 as u32)) as u32;

const signed64 = ((4611686018427387904n as i64) * (2n as i64)) as i64;
const unsigned64Zero = ((9223372036854775808n as u64) * (2n as u64)) as u64;
const unsigned64 = (unsigned64Zero - (1n as u64)) as u64;
const signedSize = ((4611686018427387904n as isize) * (2n as isize)) as isize;
const unsignedSizeZero = ((9223372036854775808n as usize) * (2n as usize)) as usize;
const unsignedSize = (unsignedSizeZero - (1n as usize)) as usize;
